...
<div align="center">
  <img src="../images/3-pr-popup.png" alt="GitHub banner prompting to create a pull request from a recently pushed branch" width="600">
</div>
...
<div align="center">
  <img src="../images/3-pr-landing-page.png" alt="The New pull request button on the GitHub repository page" width="800">
</div>

You will then be able to choose which branch you want to create a PR for. For example here, I can choose `feature-branch-1`.

<div align="center">
  <img src="../images/3-pr-comparisons.png" alt="GitHub branch comparison dropdown for choosing the PR source branch" width="600">
</div>
...
<div align="center">
  <img src="../images/3-pr-form.png" alt="The GitHub pull request form with title and description fields" width="800">
</div>
...
:pencil2: Merge the pull request into `main`. You do this in the `Conversation` tab, at the very bottom.
